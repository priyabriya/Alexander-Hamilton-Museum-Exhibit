...
Curator: Then a narrowing pass: which four artifacts tell the clearest story together? Not the longest list, the most coherent one.
Copywriter: Then actual drafting, with a clear brief on tone — specific, muscular, no filler. The homepage line "built a nation with words" went through a bunch of iterations before landing.
Critic: Finally, Claude was asked to read the whole thing as a skeptical first-time visitor and poke holes in it. That pass found the thin spots and missing context.

Running it as researcher → curator → copywriter → critic made the output way more coherent than a single prompt ever would have.

**_Planning, Building, Reviewing, Improving_**

_Planning_: The first decision was finding a focused angle. Hamilton does too much to cover everything, so "the pen" became the filter — only include what connects to writing or institution-building. The three audience personas came early too, because the site needed multiple ways in without losing its thread.
_Building_: Copy came before design. The page order — Home, Artifacts, Timeline, Audience — was mapped to what a new visitor actually needs in sequence: who is this, what did he leave behind, when did things happen, why does it matter.
_Reviewing_: The site got read through the eyes of three different visitors — the high schooler who just saw the musical, the teacher building a lesson plan, and someone who clicked a random link with no context. Each one surfaced something different. The musical fan needed the Hurricane Letter flagged as Hamilton's "origin scene." The teacher needed working links to real primary sources. The random visitor needed the stats front and center just to get oriented.
_Improving_: Two things got tightened up. First, the copy voice — early drafts sounded too much like a Wikipedia summary and had to be rewritten to have more edge. Second, the Audience page — the "Three Ways In" section was redesigned so each entry point links directly to the most relevant artifact for that visitor, making it actually useful instead of just decorative.
